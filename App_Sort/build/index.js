...
const numbersCollection = new NumbersCollection_1.NumbersCollection([5, 111, 50, -29, 12]);
const sorter = new Sorter_1.Sorter(numbersCollection);
sorter.sort();
console.log(numbersCollection.data);
const charactersCollection = new CharactersCollection_1.CharactersCollection("Zxbndta");
